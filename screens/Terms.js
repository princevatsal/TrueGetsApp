    ...
    <View style={{flex: 1}}>
      ...
      <ScrollView
        ...
        <Text style={{fontSize: 20, fontWeight: 'bold'}}>
          Your App may use the Terms and Conditions given below
        </Text>
        <Unorderedlist bulletUnicode={0x2022} style={{fontSize: 40}}>
          <Text style={styles.bulletext}>
            The terms "We" / "Us" / "Our"/ “Company” individually and
            collectively refer to “Truegets” and the terms "Visitor” / “User”
            refers to the users.
          </Text>
        </Unorderedlist>
        <Unorderedlist bulletUnicode={0x2022} style={{fontSize: 40}}>
          <Text style={styles.bulletext}>
            ...
            respective rights to revise these Terms and Conditions at any time
            by updating this posting. You should visit this page periodically to
        ...
        <Unorderedlist bulletUnicode={0x2022} style={{fontSize: 40}}>
          <Text style={styles.bulletext}>
            ...
            under license, by the business and/or its associate entities who
        ...
        <Unorderedlist bulletUnicode={0x2022} style={{fontSize: 40}}>
          <Text style={styles.bulletext}>
            ...
            the respective organization’s or entity’s written permission.
          </Text>
        </Unorderedlist>
        <Text style={{fontSize: 20, fontWeight: 'bold', marginTop: '5%'}}>
          Acceptable Use
        ...
        <Unorderedlist bulletUnicode={0x2022} style={{fontSize: 40}}>
          <Text style={styles.bulletext}>
            ...
            security of the Website, including, without limitation, (1)
            accessing data not intended for such user or logging into a server
            or account which the user is not authorized to access, (2)
            ...
            proper authorization, (3) attempting to interfere with service to
        ...
        <Unorderedlist bulletUnicode={0x2022} style={{fontSize: 40}}>
          <Text style={styles.bulletext}>
            ...
            conduct that would be considered a criminal offense or violate any
            ...
            personal rights of others, or (c) that is libelous, defamatory,
        ...
        <Unorderedlist bulletUnicode={0x2022} style={{fontSize: 40}}>
          <Text style={styles.bulletext}>
            ...
            resulting from their use of datingwipe.com or their breach of the
            terms.
          </Text>
        </Unorderedlist>
        <Text style={{fontSize: 20, fontWeight: 'bold', marginTop: '5%'}}>
        ...
        <Unorderedlist bulletUnicode={0x2022} style={{fontSize: 40}}>
          <Text style={styles.bulletext}>
            ...
            use the service or/and for the cost of procurement of substitute
            goods or/and services or resulting from any goods or/and data or/and
        ...
        <Unorderedlist bulletUnicode={0x2022} style={{fontSize: 40}}>
          <Text style={styles.bulletext}>
            ...
            service. In sum, in no event, shall the Company's total liability to
