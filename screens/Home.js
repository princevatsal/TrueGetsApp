...
import { View, Text, SafeAreaView,Image, StyleSheet, ScrollView, TouchableOpacity, ImageBackground } from 'react-native';
  ...
  return (
    ...
    <View style={styles.mainCont}>
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
       ...
       <Image source={chat_grey} style={{width: 25, height: 25}} />
                  </TouchableOpacity>
                </View>
              </ImageBackground>
            </TouchableOpacity>
